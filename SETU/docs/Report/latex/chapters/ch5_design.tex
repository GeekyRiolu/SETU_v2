...
\begin{itemize}
  ...
  \item \textbf{Gradient-norm clipping at 1.0.} The single most important
        ...
        output while the identical code at 120{,}000 sentences had succeeded
        --- more steps simply meant more opportunities to hit a gradient spike.
...
\midrule
\endfirsthead
\multicolumn{1}{c}{\textit{Table \thetable{} --- continued from previous page}}\\
\toprule
\rowcolor{headblue}
\textbf{Input:} cleaned corpus $C = \{(x_i, y_i)\}_{i=1}^{N}$; teacher $T$; student architecture $\theta$ \\
\rowcolor{headblue}
